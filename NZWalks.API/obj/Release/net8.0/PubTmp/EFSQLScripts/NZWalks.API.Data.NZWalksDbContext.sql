...
IF NOT EXISTS (
    ...
    WHERE [MigrationId] = N'20240927150814_Initial Migration'
)
BEGIN
...
BEGIN
    ...
    VALUES (N'20240927150814_Initial Migration', N'8.0.10');
END;
GO
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20241007215812_Seeding data for Difficulties and Regions'
)
BEGIN
    ...
    VALUES (''950d715f-8cf8-428a-9b84-71694be8071f'', N''Hard''),
    (''9e3dce43-9269-48ad-9de1-9f28e14878bc'', N''Easy''),
    (''bceb6e8b-6610-4e66-afab-732a270b33b3'', N''Medium'')');
    IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'Name') AND [object_id] = OBJECT_ID(N'[Difficulties]'))
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20241007215812_Seeding data for Difficulties and Regions', N'8.0.10');
END;
GO
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20241018150055_Adding Images Table'
)
BEGIN
    CREATE TABLE [Images] (
        [Id] uniqueidentifier NOT NULL,
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20241018150055_Adding Images Table', N'8.0.10');
END;
GO
